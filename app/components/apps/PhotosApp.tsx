...
const PHOTOS = [
  { id: 1, label: "Terminal Portfolio Website", gradient: "linear-gradient(135deg, #0e0b1a 0%, #4d8dff 50%, #00f5ff 100%)" },
  { id: 2, label: "VR Multiplayer Court Room — AFP", gradient: "linear-gradient(135deg, #07050f 0%, #ff2d78 50%, #4d8dff 100%)" },
  ...
  { id: 6, label: "Filler Image", gradient: "linear-gradient(135deg, #07050f 0%, #39ff14 40%, #4d8dff 100%)" },
  { id: 7, label: "Filler Image", gradient: "linear-gradient(135deg, #050310 0%, #ff2d78 30%, #ffb830 100%)" },
  { id: 8, label: "Filler Image", gradient: "linear-gradient(135deg, #080614 0%, #4d8dff 40%, #ff2d78 100%)" },
];
